    ...
    <div className="fixed inset-0 z-[100] bg-black/75 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-3xl w-full shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col my-auto max-h-[90vh]">
        ...
        <div className="p-6 sm:p-8 flex-1 overflow-y-auto space-y-8">
          ...
          {book && (
            <div className="p-5 rounded-3xl bg-gradient-to-br from-blue-600 via-indigo-700 to-slate-950 text-white shadow-xl space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="shrink-0 flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2.5 rounded-2xl bg-white text-blue-900 font-extrabold text-xs shadow-lg hover:bg-blue-50 active:scale-95 transition-all flex items-center gap-2"
                  >
                    {downloadSuccess ? (
                      <>
                  ...
                  {downloadSuccess && onOpenInApp && (
                    <button
                      ...
                      className="px-4 py-2.5 rounded-2xl bg-blue-950 text-white font-extrabold text-xs shadow-lg hover:bg-black active:scale-95 transition-all flex items-center gap-1.5 border border-blue-500/40 animate-pulse"
                    >
          ...
          {/* Quick Notice */}
          <div className="p-4 rounded-2xl bg-gradient-to-r from-sky-50 to-blue-50 dark:from-sky-950/40 dark:to-blue-950/40 border border-sky-200 dark:border-sky-800/60 text-xs text-slate-700 dark:text-slate-300 flex items-start gap-3">
            <HardDrive className="w-5 h-5 text-blue-600 dark:text-sky-400 shrink-0 mt-0.5" />
            <div>
              <strong className="text-blue-800 dark:text-sky-300 font-bold">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {portalSources.map((src) => (
                ...
                >
                  <div className="space-y-1.5">
                    <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-sky-300 font-extrabold text-[10px] rounded-full">
                      {src.badge}
                    </span>
                  ...
                  <div className="text-[10px] text-blue-600 dark:text-sky-400 font-bold mt-3 pt-2 border-t border-slate-200/60 dark:border-slate-700">
