...
export const CommunityPostsPage: React.FC<CommunityPostsPageProps> = ({
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in duration-200">
      ...
      {/* Official & Useful Learning Links Bar */}
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-4 sm:p-5 shadow-sm space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-xs sm:text-sm font-black text-slate-900 dark:text-white">
            ...
            <span>Important Links & Official Portals</span>
          </div>
          <span className="text-[11px] text-slate-400 font-bold hidden sm:inline">
            Direct access to official educational portals & resources
          </span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 hover:bg-indigo-50 dark:hover:bg-indigo-950/60 text-slate-700 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 border border-slate-200 dark:border-slate-800 text-xs font-bold transition-all shadow-xs active:scale-95"
          >
          ...
          <a
            href="https://t.me/ethio_students_grade5_8"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 hover:bg-sky-50 dark:hover:bg-sky-950/60 text-slate-700 dark:text-slate-300 hover:text-sky-600 dark:hover:text-sky-400 border border-slate-200 dark:border-slate-800 text-xs font-bold transition-all shadow-xs active:scale-95"
          >
            <Send className="w-3.5 h-3.5 text-sky-500" />
            <span>Telegram Study Channel</span>
            <ExternalLink className="w-3 h-3 opacity-60" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 hover:bg-emerald-50 dark:hover:bg-emerald-950/60 text-slate-700 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 border border-slate-200 dark:border-slate-800 text-xs font-bold transition-all shadow-xs active:scale-95"
          >
            <Award className="w-3.5 h-3.5 text-emerald-500" />
            <span>EAES National Exam Agency</span>
            <ExternalLink className="w-3 h-3 opacity-60" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 hover:bg-rose-50 dark:hover:bg-rose-950/60 text-slate-700 dark:text-slate-300 hover:text-rose-600 dark:hover:text-rose-400 border border-slate-200 dark:border-slate-800 text-xs font-bold transition-all shadow-xs active:scale-95"
          >
            <PlayCircle className="w-3.5 h-3.5 text-rose-500" />
            <span>Video Lessons & Guides</span>
            <ExternalLink className="w-3 h-3 opacity-60" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 hover:bg-amber-50 dark:hover:bg-amber-950/60 text-slate-700 dark:text-slate-300 hover:text-amber-600 dark:hover:text-amber-400 border border-slate-200 dark:border-slate-800 text-xs font-bold transition-all shadow-xs active:scale-95"
          >
            <FileText className="w-3.5 h-3.5 text-amber-500" />
            <span>Supplemental Study Drive</span>
            <ExternalLink className="w-3 h-3 opacity-60" />
          </a>
        </div>
      </div>
